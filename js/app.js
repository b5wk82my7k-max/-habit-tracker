...
(function () {
  ...
  function getMonthPrefix() {
    return (
      Grid.currentYear +
      "-" +
      String(Grid.currentMonth).padStart(2, "0")
    );
  }
  ...
  function getMonthCompletions() {
    ...
    return getCompletions().filter(completion =>
      String(completion.dateKey).startsWith(prefix)
    );
  }
  ...
  function addHabitButton() {
    ...
    if (document.getElementById("add-habit-button")) {
      return;
    }
  ...
  function startApp() {
    ...
    if (
      ...
      console.error(
        "Habit Tracker: Required JavaScript module is missing."
      );
  ...
  /* =======================================================
     ...
     Grid.js can call these functions.
  ======================================================= */
  ...
  window.calculateHabitBestStreak =
    calculateHabitBestStreak;

  window.calculateHabitCurrentStreak =
    calculateHabitCurrentStreak;

  window.updateDashboard =
    updateDashboard;

  window.addHabitButton =
    addHabitButton;

  window.addStatsButton =
    addStatsButton;

  window.addSettingsButton =
    addSettingsButton;
